...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">汽车租赁网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>CarInfo/frontlist.aspx">汽车信息</a></li>
                <li><a href="<%=basePath %>CarRent/frontlist.aspx">租车信息</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>CarRent/userFrontlist.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的租车信息</a></li>
